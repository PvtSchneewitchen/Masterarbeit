...
namespace GracesGames.SimpleFileBrowser.Scripts.UI {
    ...
    public class LandscapeUserInterface : UserInterface {
        ...
        protected override void SetupParents() {
            ...
            Utilities.FindGameObjectOrError("TopContainer").GetComponent<Image>().color = DirectoryPanelColor; 
            Utilities.FindGameObjectOrError("BottomContainer").GetComponent<Image>().color = DirectoryPanelColor;
        }
    }
}
