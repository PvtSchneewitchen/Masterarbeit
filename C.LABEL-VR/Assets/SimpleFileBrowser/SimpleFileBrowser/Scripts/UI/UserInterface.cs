...
namespace GracesGames.SimpleFileBrowser.Scripts.UI {
	...
	public abstract class UserInterface : MonoBehaviour {
        ...
        public Color DirectoryPanelColor = new Color32(0, 137, 207, 255);

        // Color used for the File Panel
        //public Color FilePanelColor = Color.grey;
        public Color FilePanelColor = new Color32(0, 137, 207, 255);
        ...
        {
            Utilities.FindGameObjectOrError("PathLabel").GetComponent<Text>().color = ItemFontColor;
            Utilities.FindGameObjectOrError("PathText").GetComponent<Text>().color = ItemFontColor;
            Utilities.FindGameObjectOrError("FileLabel").GetComponent<Text>().color = ItemFontColor;
            Utilities.FindGameObjectOrError("LoadFileText").GetComponent<Text>().color = ItemFontColor;
        }
