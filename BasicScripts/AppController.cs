...
public class AppController : MonoBehaviour
{
	...
	void Start ()
	{
		...
		if (bMultipleFiles)
		{
			...
			{
				Coordinates = PcdReader.GetCoordinatesFromMultiPcd ("C:\\Users\\gruepazu\\Desktop\\Lidar18.8\\LidarImages_03_05\\PCD\\");
			}
			else
			{
				string sFolderToCut = "/PointCloudFly_Data/";
		...
		{
			Coordinates = PcdReader.GetCoordinatesFromSinglePcd ("C:\\Users\\gruepazu\\Desktop\\Lidar18.8\\LidarImages_03_05\\PCD\\000000000_LidarImage_000000002.pcd");
		}
