...
public class LabelPointSave
{
	...
	public LabelPointSave (LabelPoint Point_inp)
	{
		x = Point_inp.point.transform.position.x;
		y = Point_inp.point.transform.position.y;
		z = Point_inp.point.transform.position.z;

		labelingClassGroup = Point_inp.labelingClassGroup;
